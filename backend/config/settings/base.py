"""
Django settings for AAC Communication Cards project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'aac_db'),
...
AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME', 'aac-cards')
...
GOOGLE_TRANSLATE_ENABLED = os.environ.get('GOOGLE_TRANSLATE_ENABLED', 'True') == 'True'
