...
- Пользовательские категории: создаются в мастере из 3 шагов:
  1. Ввод названия.
  2. AI-генерация обложки (или выбор из галереи / повторная генерация с возвратом на шаг 1).
  3. Добавление карточек из пула «Без категории» и сохранение.
...
CreateCategoryFlow (sheet)
 ...
 Step 3: Превью обложки (перегенерировать → возврат на шаг 1 / выбрать из галереи)
 Step 4: Добавить карточки из пула "Без категории" → bulk-назначение и сохранение
 Step 5: Успех
```
